...
public class CatalogModifyingGenerateEnginesStrategy extends NonModifyingGenerateEnginesStrategy
{
    ...
    * The constructor.
    * 
    * @param catalogResource The deficiency catalog for which the engines should be generated.
    * @param selectedComponents The user-selected components in which the deficiencies should be
    *           detected.
    */
    ...
    * 
    * @param selectedComponents The user-selected components. This should not be null or empty as
    *           the wizard should prevent it.
