...
/**
 * <!-- begin-user-doc --> A representation of the literals of the enumeration '<em><b>Order Constraint Type</b></em>', and utility methods for working with them. <!-- end-user-doc
 * -->
 * 
 * @see org.storydriven.modeling.patterns.PatternsPackage#getOrderConstraintType()
 * @model
 * @generated
 */
public enum OrderConstraintType implements Enumerator
{
   /**
   ...
   /**
    * An array of all the '<em><b>Order Constraint Type</b></em>' enumerators.
    * <!-- begin-user-doc --> <!-- end-user-doc -->
    * @generated
    */
   private static final OrderConstraintType[] VALUES_ARRAY = new OrderConstraintType[] {FIRST, LAST, DIRECT, INDIRECT,
         INDEX,};

   /**
    * A public read-only list of all the '<em><b>Order Constraint Type</b></em>' enumerators.
    * <!-- begin-user-doc --> <!-- end-user-doc -->
    * @generated
    */
   public static final List<OrderConstraintType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

   /**
    * Returns the '<em><b>Order Constraint Type</b></em>' literal with the specified literal value.
    * <!-- begin-user-doc --> <!-- end-user-doc -->
    * @generated
    */
   public static OrderConstraintType get (String literal)
   {
      for (int i = 0; i < VALUES_ARRAY.length; ++i)
      {
         OrderConstraintType result = VALUES_ARRAY[i];
   ...
   /**
    * Returns the '<em><b>Order Constraint Type</b></em>' literal with the specified name.
    * <!-- begin-user-doc --> <!-- end-user-doc -->
    * @generated
    */
   public static OrderConstraintType getByName (String name)
   {
      for (int i = 0; i < VALUES_ARRAY.length; ++i)
      {
         OrderConstraintType result = VALUES_ARRAY[i];
   ...
   /**
    * Returns the '<em><b>Order Constraint Type</b></em>' literal with the specified integer value.
    * <!-- begin-user-doc --> <!-- end-user-doc -->
    * @generated
    */
   public static OrderConstraintType get (int value)
   {
      switch (value)
      {
         case FIRST_VALUE:
    ...
    * @generated
    */
   private OrderConstraintType (int value, String name, String literal)
   {
      this.value = value;
      this.name = name;
