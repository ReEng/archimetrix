...
{
   private static final String WIZARD_PAGE_DESCRIPTION_LONG = "Select a file with the detected bad smells and a file with the reengineering strategies.";
   ...
   private void createInputsGroup(final Composite composite)
   {
      ...
      if (this.selectedAnnotationFromRelevantBadSmellsView == null)
      {
         ...
         this.badSmellsSection = this.resourceSelectionSectionProvider.createBadSmellsResourceSelection(inputs, this);
      }
      this.reStrategiesSection = this.resourceSelectionSectionProvider
            .createReengineeringStrategiesSelection(inputs, this);
   }
