...
public class ArchitecturePreviewWizard extends Wizard
{
   ...
   private static final class ArchitecturePreviewJob extends Job
   {
         ...
         final Repository oldSAMM)
   {
      ...
      try
      {
         ArchitecturePreviewView architecturePreviewView = (ArchitecturePreviewView) activePage
               .showView(ArchitecturePreviewView.ID);
         architecturePreviewView.setInput(results);
         architecturePreviewView.setNewComponentsTreeInput(newSAMM);
         architecturePreviewView.setOriginalComponentsTreeInput(oldSAMM);
         architecturePreviewView.setFocus();
      }
      catch (PartInitException e)
      {
         ArchitecturePreviewPlugin.getDefault().logError("Error occurred during showing preview results.", e);
      }
   }
   ...
   public Resource getBadSmellsResource()
   {
      ...
      return ResourceLoader.loadResource(badSmellsFilePath);
   }
   ...
   public Resource getReengineeringStrategiesResource()
   {
      ...
      return ResourceLoader.loadResource(reengineeringStrategysFilePath);
   }
