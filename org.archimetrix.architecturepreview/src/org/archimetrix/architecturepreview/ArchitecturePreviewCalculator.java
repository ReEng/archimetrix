...
/**
 * This class controls the architecture preview calculations. It collects the required data and
...
public class ArchitecturePreviewCalculator
{
   ...
   // used to collect the data shown in the line "total components" in the architecture preview
   // view
   ...
   // used to collect the data shown in the line "interfaces" in the architecture preview view
   private List<String> interfacesLine;

   // used to collect the data shown in the line "messages" in the architecture preview view
   private List<String> messagesLine;

   // contains all lines required for the architecture preview view and will be returned when
   ...
   /**
    * Starts the architecture preview.
    * 
    * @return The data required for the Architecture Preview.
    */
