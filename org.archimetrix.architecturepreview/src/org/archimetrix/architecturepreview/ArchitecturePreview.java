...
public class ArchitecturePreview
{
   ...
   ArchitecturePreviewCalculator previewCalculator;
         ...
         final String metricValuesFilePath)
   {
      ...
      startPreviewCalculation(badSmellAnnotation, somoxStarter);
      return this.previewCalculator.start();
   }


   private void startPreviewCalculation(final ASGAnnotation badSmellAnnotation, SoMoXStarter somoxStarter)
   {
      ...
      this.previewCalculator = new ArchitecturePreviewCalculator(originalSCDM, newSCDM);
   }
   ...
   {
      return this.previewCalculator.getNewSammRep();
   }
   ...
   {
      return this.previewCalculator.getOriginalSammRep();
   }
   ...
   private void fixGASTResource(final Resource newGASTResource)
   {
      ...
      {
         ArchitecturePreviewPlugin.getDefault().logError("Error occurred during transformation", e);
      }
      catch (IOException e)
      {
         ArchitecturePreviewPlugin.getDefault().logError("Error occurred during transformation", e);
