 ...
 */
public class SelectComponentPage extends WizardPage
{
   ...
   protected SelectComponentPage()
   {
      super(SelectComponentPage.class.getName());
      ...
      if (this.selection != null)
      {
         ...
         catch (IOException e)
         {
            MessageDialog.openError(getShell(), "Could not load model",
                  "The selected model could not be loaded because of an Exception " + e);
            e.printStackTrace();
         }
   ...
   protected void setSelection(Resource selection)
   {
      ...
      viewer.setSubtreeChecked(sammModel, true);
   }


   public Collection<Object> getCheckedObjects()
   {
      return elements;
   }
